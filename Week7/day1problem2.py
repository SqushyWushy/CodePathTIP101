...
# Given the base case and recursive case, write a function factorial() that returns the factorial of a non-negative
# integer n. The factorial of a number is the product of all numbers between 1 and n.
#
